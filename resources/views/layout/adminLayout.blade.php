...
<head>
    ...
    <link href="{{asset('/admin_assets/css/themes/layout/aside/light.css')}}" rel="stylesheet" type="text/css"/>
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="/" class="brand-logo">
                    <img alt="Logo" style="margin: 3px 10px 0 !important; width: 100px;" src="{{asset('logo.png')}}"/>
                    <!--<img alt="Logo" src="" />-->
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="" target="_blank" class="text-dark-75 text-hover-primary">2022</a>
                    </div>
                </div>
            </div>
            <!--end::Footer-->
...
{{--					</div>--}}
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="{{url('/admin/logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">logout</a>
...
{{--									</span>--}}
							...
							<div class="navi-text">
								<div class="font-weight-bold">Change_Password</div>
